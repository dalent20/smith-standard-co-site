    ...
    <main className="min-h-screen bg-[#f1f0eb] pt-24 text-zinc-950">
      <section className="px-5 pb-20 pt-16 sm:px-8 sm:pb-28 sm:pt-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-5 grid gap-12 lg:grid-cols-[1fr_.8fr] lg:items-end">
            <div><h1 className="max-w-5xl text-6xl font-medium leading-[.9] tracking-[-0.06em] sm:text-8xl">Have a question?<br /><span className="font-serif italic font-normal">Talk to us.</span></h1><p className="mt-7 max-w-2xl text-base leading-7 text-zinc-600">Contact is here for questions, unusual vehicles, extended travel, or special circumstances. If you're ready for a normal appointment, booking is faster.</p><Link href="/booking" className="mt-7 inline-flex items-center gap-2 rounded-xl bg-black px-6 py-4 text-xs font-bold uppercase tracking-[0.14em] text-white">Book Your Detail <ArrowRight className="h-4 w-4" /></Link></div>
      ...
      <section className="bg-black px-5 py-20 text-white sm:px-8 sm:py-28">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[.65fr_1fr]">
          <div><div className="text-[10px] font-semibold uppercase tracking-[0.22em] text-zinc-500">Secondary inquiry</div><h2 className="mt-4 text-5xl font-medium leading-[.95] tracking-[-0.055em]">Tell us what you need.</h2><p className="mt-5 text-sm leading-6 text-zinc-500">For standard appointments, use Book Now. Use this form for questions or requests that don't fit the normal booking path.</p></div>
