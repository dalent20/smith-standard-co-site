      ...
      <section className="px-5 pb-20 pt-16 sm:px-8 sm:pb-28 sm:pt-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-5 grid gap-10 lg:grid-cols-[1.2fr_.6fr] lg:items-end">
            <div><h1 className="max-w-5xl text-6xl font-medium leading-[.9] tracking-[-0.06em] sm:text-8xl">Start with<br /><span className="font-serif italic font-normal">The Standard.</span></h1><p className="mt-7 max-w-2xl text-base leading-7 text-zinc-600">If you are not sure what to book, start with the Smith Standard Detail. The booking flow adapts the estimate to your vehicle size, current condition, desired depth of care, optional needs, and service location.</p></div>
